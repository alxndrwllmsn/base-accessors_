...
#ifndef ASKAP_ACCESSORS_VOTABLE_VOTABLEPARAM2_H
#define ASKAP_ACCESSORS_VOTABLE_VOTABLEPARAM2_H
    ...
    namespace accessors {
        ...
        class VOTableParam2 {
            public:
                ...
                static VOTableParam2 fromXmlElement(const tinyxml2::XMLElement& paramElement);
