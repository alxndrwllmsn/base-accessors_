...
public:
	...
	virtual const casacore::Vector<casacore::Float>& feed1PA() const = 0;

	/// Position angles of the second feed for all rows
	/// @return a vector with position angles (in radians) of the
	/// second feed corresponding to each visibility
	virtual const casacore::Vector<casacore::Float>& feed2PA() const = 0;
	...
	/// visibility/row
	virtual const casacore::Vector<casacore::MVDirection>& pointingDir1() const = 0;

        /// Pointing centre directions of the second antenna/feed
	/// @return a vector with direction measures (coordinate system
	/// is is set via IDataConverter), one direction for each
	/// visibility/row
	virtual const casacore::Vector<casacore::MVDirection>& pointingDir2() const = 0;
	...
	/// is is set via IDataConverter), one direction for each
	/// visibility/row
	virtual const casacore::Vector<casacore::MVDirection>& dishPointing1() const = 0;
	...
	/// is is set via IDataConverter), one direction for each
	/// visibility/row
	virtual const casacore::Vector<casacore::MVDirection>& dishPointing2() const = 0;
	...
	virtual const casacore::Vector<casacore::RigidVector<casacore::Double, 3> >&
	         rotatedUVW(const casacore::MDirection &tangentPoint) const = 0;
	...
	virtual const casacore::Vector<casacore::Double>& uvwRotationDelay(
	         const casacore::MDirection &tangentPoint, const casacore::MDirection &imageCentre) const = 0;
	...
	virtual const casacore::Vector<casacore::Double>& frequency() const = 0;
	...
	virtual const casacore::Vector<casacore::Double>& velocity() const = 0;
	...
	virtual const casacore::Vector<casacore::Stokes::StokesTypes>& stokes() const = 0;
};
